...
int DecompressCore(const char * pInputFilename, const char * pOutputFilename, int nOutputMode, int nCompressionLevel, IAPEProgressCallback * pProgressCallback);
...
{
    CSmartPtr<char> spInputFile(const_cast<char*>(pInputFilename), TRUE);
    CSmartPtr<char> spOutputFile(const_cast<char*>(pOutputFilename), TRUE);
...
*****************************************************************************************/
int __stdcall CompressFileW(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
...
int __stdcall VerifyFileW(const char * pInputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag, BOOL bQuickVerifyIfPossible)
{
    CAPEProgressCallbackLegacy ProgressCallbackLegacy(pPercentageDone, ProgressCallback, pKillFlag);
    return VerifyFileW2(pInputFilename, &ProgressCallbackLegacy, bQuickVerifyIfPossible);
}

int __stdcall DecompressFileW(const char * pInputFilename, const char * pOutputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
    CAPEProgressCallbackLegacy ProgressCallbackLegacy(pPercentageDone, ProgressCallback, pKillFlag);
    return DecompressFileW2(pInputFilename, pOutputFilename, &ProgressCallbackLegacy);
}

int __stdcall ConvertFileW(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag)
{
    CAPEProgressCallbackLegacy ProgressCallbackLegacy(pPercentageDone, ProgressCallback, pKillFlag);
...
Compress file
*****************************************************************************************/
int __stdcall CompressFileW2(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel, IAPEProgressCallback * pProgressCallback)
{
...
Verify file
*****************************************************************************************/
int __stdcall VerifyFileW2(const char * pInputFilename, IAPEProgressCallback * pProgressCallback, BOOL bQuickVerifyIfPossible)
{
...
Decompress file
*****************************************************************************************/
int __stdcall DecompressFileW2(const char * pInputFilename, const char * pOutputFilename, IAPEProgressCallback * pProgressCallback)
{
...
Convert file
*****************************************************************************************/
int __stdcall ConvertFileW2(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel, IAPEProgressCallback * pProgressCallback) 
{
